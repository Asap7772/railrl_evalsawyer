...
class SpaceMouseLinux:
    ...
    def __init__(self, blocking=False, max_action_norm=1., xyz='right,up,forward'):
    ...
    def get_controller_state(self):
        ...
        return dict(
            ...
            pitch=self.pitch,
            yaw=self.yaw,
            left_click=self._reset_state,
            right_click=self._single_click_and_hold,
        )
    ...
    def run(self):
        ...
        while not stop:
            ...
            if (
                ...
                self._reset_state = event.pressed  
