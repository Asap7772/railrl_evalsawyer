"""
From: https://raw.githubusercontent.com/eifuentes/swae-pytorch/master/swae/trainer.py
"""
import numpy as np
...
def rand_projections(embedding_dim, num_samples=50):
    ...
    """
    return torch.stack([
        w / (w**2).sum().sqrt()  # L2 normalization
        for w in ptu.randn((num_samples, embedding_dim))
    ])
