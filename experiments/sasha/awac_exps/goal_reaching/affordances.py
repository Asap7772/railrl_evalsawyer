...
from roboverse.envs.sawyer_rig_multiobj_drawer_v0 import SawyerRigMultiobjDrawerV0
...
demo_paths=[dict(path='sasha/affordances/gr_affordance_fixed_env_demos_0.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/gr_affordance_fixed_env_demos_1.pkl', obs_dict=True, is_demo=True),
            dict(path='sasha/affordances/gr_affordance_fixed_env_demos_2.pkl', obs_dict=True, is_demo=True),]

mug_goals = 'sasha/presampled_goals/fixed_drawer_mug.pkl'

if __name__ == "__main__":
    variant = dict(
        imsize=48,
        env_class=SawyerRigMultiobjDrawerV0,
        env_kwargs=dict(
            random_color_p=0,
        ),
        ...
        train_vae_kwargs=dict(
            ...
            generate_vae_dataset_kwargs=dict(
                ...
                n_random_steps=2,
                test_p=.9,
                dataset_path={'train': 'sasha/affordances/gr_affordance_fixed_env_images.npy',
                              'test': 'sasha/affordances/gr_affordance_fixed_env_test_images.npy'},
                augment_data=False,
                use_cached=False,
                show=False,
    ...
    search_space = {
        ...
        'env_kwargs.object_subset': [['mug']],

        'reward_kwargs.epsilon': [4, 5, 5.5, 6, 7],
        'trainer_kwargs.beta': [0.3], #[0.3, 0.5, 1.0]
