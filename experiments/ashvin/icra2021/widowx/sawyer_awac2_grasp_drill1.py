...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/dataset_v2/goals_drill_grasp_final.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/dataset_v2/goals_drill_grasp_final_pixelcnn.npy',
        ),
