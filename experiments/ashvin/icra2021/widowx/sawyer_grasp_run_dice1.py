...
demo_paths_1 = [
    dict(
        path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_grasp_data.npy',
        obs_dict=True,
        is_demo=True,
    ),
]
...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/datasets/goals_dice_grasp.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/datasets/goals_dice_grasp.npy',
        ),
