...
demo_paths_1 = [
    dict(
        path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_data.npy',
        obs_dict=True,
        is_demo=True,
    ),
]
...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/datasets/goals_obj2.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/datasets/goals_obj2.npy',
        ),
        ...
        #num_presample=50,
        pretrained_vae_path="/home/ashvin/data/s3doodad/ashvin/icra2021/widowx/sawyer-exp/run3/id0/itr_1500.pt",
        pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/widowx/sawyer-robot-exp/run5/id0/itr_0.pt",
        pickle_paths=True,
    )
