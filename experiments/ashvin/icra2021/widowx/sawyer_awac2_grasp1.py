...
# demo_paths_1 = [
#     dict(
#         path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_mixed_v1.npy',
#         obs_dict=True,
#         is_demo=False,
#     ),
#     dict(
#         path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_grasp_augment_data.npy',
#         obs_dict=True,
#         is_demo=False,
#     ),
#     dict( # 5510
#         path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_drawerclose_v1.npy',
#         obs_dict=True,
#         is_demo=False,
#     ),
#     dict( # all data together
#         path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_draweropen_v1.npy',
#         obs_dict=True,
#         is_demo=True,
#     ),
# ]
# demo_paths_1 = [ # 113650
#     dict( # all data together
#         path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/offpolicy_augment_data_v1.npy',
#         obs_dict=True,
#         is_demo=True,
#     ),
# ]
...
demo_paths_1 = [ # 
    dict( # all data together
        path='/home/ashvin/data/s3doodad/demos/icra2021/dataset_v2/offpolicy_v2.npy',
        obs_dict=True,
        is_demo=True,
    ),
    # dict( # all data together
    #     path='/home/ashvin/data/s3doodad/demos/icra2021/dataset_v2/offpolicy_drawervertical_close1_v2.npy',
    #     obs_dict=True,
    #     is_demo=True,
    # ),
]
...
if __name__ == "__main__":
    variant = dict(
        ...
        # exploration_goal_sampling_mode="presampled_images", # "presampled_latents",
        exploration_goal_sampling_mode="presampled_latents", # "presampled_latents",
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/dataset_v2/goals_grasp_elephant_final.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/dataset_v2/goals_grasp_elephant_final_pixelcnn.npy',
        ),
        ...
        # pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/widowx/sawyer-awac2-drawervertical-close1/run1/id0/itr_0.pt",
    )
