...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            ...
            expl_goals=None,
            #expl_goals='/media/ashvin/data2/data/val/v1/curr_goal_eval_goals.pkl',
        ),
        ...
        # WARNING, MAKE EPS MATCH!!
        pretrained_algo_path=path_func('fixed_agent.pt'), # fixed_agent_eps.pt general_agent.pt fixed_agent.pt
    )
    ...
    search_space = {
        ...
        'reward_kwargs.epsilon': [2.0,], #1.75 is mean # Make this match!!!!!!!!!
