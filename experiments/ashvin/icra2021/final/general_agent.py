...
path_func = lambda name: '/media/ashvin/data2/data/general_data/' + name
...
all_demos = [
    ...
    dict(path=path_func('general_demos.npy'), obs_dict=True, is_demo=True,), #try with and without?
]
...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            #eval_goals='/media/ashvin/data2/data/val/v1/pickup_shoe_eval_goals.pkl',
        ...
        pretrained_algo_path=path_func('general_agent.pt'), # fixed_agent_eps.pt, general_agent.pt, fixed_agent.pt
    )
    ...
    search_space = {
        ...
        'reward_kwargs.epsilon': [2.0,], #1.75 is mean
