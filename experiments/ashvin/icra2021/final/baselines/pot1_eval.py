...
if __name__ == "__main__":
    variant = dict(
        ...
        pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/final/baselines/pot1/run0/id0/itr_0.pt", # path_func('agent_sparse_1.pt'), #agent_sparse_1.pt, agent_sparse_2.pt, agent_dense.pt
    )
