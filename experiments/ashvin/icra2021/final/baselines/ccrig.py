...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/close_drawer_goal_eval_goals.pkl',
            expl_goals=None,
        ),
    ...
    search_space = {
        ...
        'reward_kwargs.reward_type': ['dense',], # TRY SPARSE (EPS=1), SPARSE (EPS=2), DENSE (PROB NOT GONNA WORK)
