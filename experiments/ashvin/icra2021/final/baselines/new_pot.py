...
mini_demos = [
    dict(path=path_func('fixed_drawer_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
    dict(path=path_func('fixed_pot_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
    dict(path=path_func('fixed_pot_extra1_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
    dict(path=path_func('fixed_drawer_extra1_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
    dict(path=path_func('fixed_pnp_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
    dict(path=path_func('fixed_tray_demos.npy'), obs_dict=True, is_demo=True, data_split=0.167),
]
