...
if __name__ == "__main__":
    variant = dict(
        ...
        algo_kwargs=dict(
            ...
            num_expl_steps_per_train_loop=75, #500
            num_trains_per_train_loop=600, #500
            min_num_steps_before_training=75, #4000
        ),
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/ccvae_pickup_shoe1_eval_goals.pkl',
            expl_goals=None,
        ),
        ...
        pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/final/baselines/pickup-shoe1/run0/id0/itr_6.pt", # path_func('agent_sparse_1.pt'), #agent_sparse_1.pt, agent_sparse_2.pt, agent_dense.pt
    )
