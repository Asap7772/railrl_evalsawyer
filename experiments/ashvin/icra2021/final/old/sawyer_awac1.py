...
if __name__ == "__main__":
    variant = dict(
        ...
        trainer_kwargs=dict(
            ...
            q_num_pretrain2_steps=25001, #25000
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/goals_v3/final_drawer_close1_pixelcnn.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/goals_v3/final_drawer_close1_pixelcnn.npy',
        ),
        ...
        # pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/widowx/sawyer-awac-giraffe1/run3/id0/itr_0.pt",
    )
