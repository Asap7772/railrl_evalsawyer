...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/train_drawer_eval_goals.pkl', # ASHVIN: UPDATE THIS
            expl_goals='/media/ashvin/data2/data/val/v1/train_drawer_eval_goals.pkl',
        ),
        ...
        #pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/final/sawyer-debug/long_train.pt",
    )
