...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/pickup_shoe_eval_goals.pkl', # ASHVIN: UPDATE THIS
        ...
        pretrained_algo_path='/home/ashvin/data/ashvin/icra2021/final/new/close-black-handle3/run0/id0/itr_9.pt',
    )
