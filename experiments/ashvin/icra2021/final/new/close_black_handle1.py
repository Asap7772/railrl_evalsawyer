...
if __name__ == "__main__":
    variant = dict(
        ...
        replay_buffer_kwargs=dict(
            ...
            fraction_distribution_context=0.0, # TODO: Try less?
        ...
        presampled_goal_kwargs=dict(
            ...
            expl_goals='/media/ashvin/data2/data/val/v1/close_horizontal_drawer1_eval_goals.pkl', # ASHVIN: UPDATE THIS
        ...
        pretrained_algo_path='/home/ashvin/data/ashvin/icra2021/final/new/close-horizontal-drawer-no-pretrained-goals1/run0/id0/itr_0.pt',
    )
