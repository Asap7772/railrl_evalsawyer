...
human_demos = [
    ...
    dict(path='/media/ashvin/data2/data/val/v1/fixed_pot_demos.npy', obs_dict=True, is_demo=False,),
    dict(path='/media/ashvin/data2/data/val/v1/fixed_pnp_demos.npy', obs_dict=True, is_demo=False,),
    dict(path='/media/ashvin/data2/data/val/v1/fixed_tray_demos.npy', obs_dict=True, is_demo=False,),
...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/obj_april11x2_eval_goals.pkl', # HERE
            expl_goals='/media/ashvin/data2/data/val/v1/obj_april11x2_expl_goals.npy',
        ),
    ...
    search_space = {
        "seed": range(2),
        'path_loader_kwargs.demo_paths': [human_demos],
