...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            ...
            eval_goals='/media/ashvin/data2/data/val/v1/pickup_dice1_eval_goals.pkl',
            expl_goals=None,
        ),
        ...
        pretrained_algo_path=path_func('pretrained_agent.pt'), #pretrained_agent.pt (fixed data polciy), pretrained_agent_eps.pt (fixed data polciy), drawer_agent.pt (drawer data policy)
    )
