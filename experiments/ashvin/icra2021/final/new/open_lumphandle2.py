...
if __name__ == "__main__":
    variant = dict(
        ...
        algo_kwargs=dict(
            ...
            num_expl_steps_per_train_loop=150, #500
        ...
        presampled_goal_kwargs=dict(
            ...
            eval_goals='/media/ashvin/data2/data/val/v1/open_lumphandle2_eval_goals.pkl',
            expl_goals=None,
        ),
        ...
        pretrained_algo_path='/home/ashvin/data/ashvin/icra2021/final/new/open-lumphandle1/run2/id0/itr_10.pt', #pretrained_agent.pt (fixed data polciy), pretrained_agent_eps.pt (fixed data polciy), drawer_agent.pt (drawer data policy)
    )
