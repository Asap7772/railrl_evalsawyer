...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/close_horizontal_drawer1_eval_goals.pkl', # ASHVIN: UPDATE THIS
            expl_goals='/media/ashvin/data2/data/val/v1/close_horizontal_drawer1_eval_goals.npy', # ASHVIN: UPDATE THIS
        ...
        pretrained_algo_path="/home/ashvin/data/ashvin/icra2021/final/new/close-red-drawer1/run1/id0/itr_0.pt",
    )

    search_space = {
        "seed": range(1),
        'path_loader_kwargs.demo_paths': [all_demos],
