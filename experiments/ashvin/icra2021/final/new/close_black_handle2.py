...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            ...
            expl_goals='/media/ashvin/data2/data/val/v1/close_blackhandle_expl_goals.npy', # ASHVIN: UPDATE THIS
        ...
        pretrained_algo_path='/home/ashvin/data/ashvin/icra2021/final/new/close-horizontal-drawer-no-pretrained-goals1/run1/id0/itr_0.pt',
    )
