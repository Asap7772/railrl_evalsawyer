...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            ...
            eval_goals='/media/ashvin/data2/data/val/v1/close_blackhandle3_eval_goals.pkl',
            expl_goals=None,
        ),
        ...
        pretrained_algo_path=path_func('general_agent_eps.pt'), # fixed_agent_eps.pt, general_agent.pt, fixed_agent.pt
    )
