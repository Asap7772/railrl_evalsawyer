...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='/media/ashvin/data2/data/val/v1/close_red_drawer1_eval_goals.pkl', # ASHVIN: UPDATE THIS
            expl_goals='/media/ashvin/data2/data/val/v1/close_red_drawer1_eval_goals.pkl', # ASHVIN: UPDATE THIS
