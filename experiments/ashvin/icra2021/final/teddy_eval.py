...
if __name__ == "__main__":
    variant = dict(
        ...
        max_path_length=200, #50 HEREHEREHERHEHER
        algo_kwargs=dict(
            ...
            min_num_steps_before_training=200, #4000
        ),
        ...
        #pretrained_algo_path='/home/ashvin/data/ashvin/icra2021/final/fixed-agent-overtrained/run3/id0/itr_3.pt'
