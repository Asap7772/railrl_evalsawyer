...
all_demos_1 = [
    dict(path=path_func('fixed_drawer_demos.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_drawer_demos_extra1.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos_extra1.npy'), obs_dict=True, is_demo=True,),
...
all_demos_2 = [
    ...
    dict(path=path_func('fixed_drawer_demos_extra1.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos_extra1.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_drawer_demos_extra2.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos_extra2.npy'), obs_dict=True, is_demo=True,),
...
all_demos_3 = [
    ...
    dict(path=path_func('fixed_drawer_demos_extra2.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos_extra2.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_drawer_demos_extra3.npy'), obs_dict=True, is_demo=True,),
    dict(path=path_func('fixed_pot_demos_extra3.npy'), obs_dict=True, is_demo=True,),
...
if __name__ == "__main__":
    variant = dict(
        ...
        replay_buffer_kwargs=dict(
            ...
            max_size=int(1E6), # HERE# HERE# HERE# HERE# HERE# HERE# HERE# HERE# HERE (DOUBLE CHECK THAT DEMOS FIT!!!!)
        ),
        ...
        #pretrained_algo_path=path_func('pretrained_agent.pt'),
    )

    search_space = {
        "seed": range(1),
        'path_loader_kwargs.demo_paths': [all_demos_0, all_demos_1, all_demos_2, all_demos_3], #CHANGED
        'policy_kwargs.hidden_sizes': [[256, 256, 256, 256, ], [64, 64]],

        'reward_kwargs.epsilon': [2.0,],
