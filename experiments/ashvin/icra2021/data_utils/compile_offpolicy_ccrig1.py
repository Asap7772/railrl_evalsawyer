...
for filename in glob.glob("/home/ashvin/data/s3doodad/demos/icra2021/v1/obj*.npy")[20:30]:
...
# for filename in glob.glob("/home/ashvin/data/s3doodad/demos/icra2021/v1/obj_drawervertical_close1.npy"):
    print(filename)
    ...
    for traj_i in range(len(data)):
        for _ in range(AUGMENT):
            ...
            cond = np.stack([traj[0]['image_observation'] for i in range(num_images)])
            latents = model.encode_np(images, cond)
...
new_filename = "/home/ashvin/data/s3doodad/demos/icra2021/dataset_v2/offpolicy_ccrig_v2_3.npy"
