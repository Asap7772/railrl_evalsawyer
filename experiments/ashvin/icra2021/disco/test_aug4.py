...
demo_paths_1 = [ # 
    dict( # all data together
        path='/home/ashvin/data/s3doodad/demos/icra2021/datasets/disco_close_drawer_aug2.npy',
        obs_dict=True,
        is_demo=True,
    ),
]
...
if __name__ == "__main__":
    variant = dict(
        ...
        presampled_goal_kwargs=dict(
            eval_goals='s3doodad/demos/icra2021/dataset_v2/goals_relocate_final.npy', # HERE
            expl_goals='s3doodad/demos/icra2021/dataset_v2/goals_relocate_final_pixelcnn.npy',
        ),
        ...
        pickle_paths=True,
        pretrained_vae_path="/home/ashvin/raw_non_set_vae_for_ashvin2.pt",
    ...
    search_space = {
        ...
        'trainer_kwargs.reward_transform_kwargs': [dict(m=0.01, b=0), ],
